...
> **직접 해보세요:** `exit`을 입력해서 세션을 닫아 보세요. (새 터미널 창은 iTerm2에서 `Cmd+N`으로 언제든 시작할 수 있습니다.)

> **참고:** 명령어 문서는 [macOS Command Line A-Z — SS64](https://ss64.com/mac/)를 참고하세요. 터미널에서 `man <명령어>`를 입력해도 됩니다 (예: `man ls`).
