...
Open your terminal, navigate to your demo repo folder, and launch your tool:
...
In VSCode, edit `TODO.md` — add a "Stretch Goals" section (or any new content you like). Save with `Ctrl+S`. Then:
