...
> **Try it yourself:** Type `exit` to close the session. (You can always open a new terminal window: `Cmd+N` on iTerm2.)

> **Reference:** For command documentation, see [macOS Command Line A-Z — SS64](https://ss64.com/mac/). You can also type `man <command>` in the terminal (e.g. `man ls`).
