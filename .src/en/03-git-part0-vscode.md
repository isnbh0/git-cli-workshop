...
> **Troubleshooting:** If you see "command not found: code", open VSCode manually, press `{{Cmd}}+Shift+P`, type "shell command", and select **"Shell Command: Install 'code' command in PATH"**. Close and reopen your terminal, then try again.
...
We won't use it much in this workshop — we'll keep using our main terminal ({{terminal_app}}). But it's good to know it exists in case you see it mentioned online.
