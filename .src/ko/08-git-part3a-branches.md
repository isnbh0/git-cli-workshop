...
> **참고:** 실제 파일 내용은 이전 단계에서 편집한 내용에 따라 다를 수 있습니다. 핵심 개념(브랜치 전환, 커밋, 병합)은 파일의 정확한 내용과 관계없이 동일하게 작동합니다.
...
> **참고:** 정확한 커밋 메시지와 개수는 이전에 완료한 섹션에 따라 다를 수 있습니다.
